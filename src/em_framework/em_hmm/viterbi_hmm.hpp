...
namespace shrg{
namespace em{
class VITERBI_HMM : public EM_VITERBI{
  public :
    VITERBI_HMM(RuleVector &shrg_rules, vector<EdsGraph> &graphs, Context *context, double
                                                                                       threshold, string dir, const string& validationDir);
    void run() override;
